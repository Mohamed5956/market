...
class CategoryController extends Controller
{
    ...
    private function delete_image($image_name){
        if($image_name !='public/images/categories/category_defualt_image.jpg'){
            try{
    ...
    private function save_image($image, $category){
        if ($image){
            $image_name = "public/images/categories/".time().'.'.$image->extension();
            $image->move(public_path('images/categories'),$image_name);
            }
        else
        {
            $image_name = "public/images/categories/category_defualt_image.jpg";
        }
